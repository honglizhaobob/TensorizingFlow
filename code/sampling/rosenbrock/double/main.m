% Double rosenbrock sampling with continuous tensor train
...
figure(1);
surf(X,Y,marginal_dm2dm1); shading interp; colorbar;
view(2);
...
xlim([-1*L2 0.1*L2]); ylim([-1*L3 1*L3]);
...
view(2);
exportgraphics(fig,'./img/drosen_dm1d.jpg','Resolution',500);
%% sample from double rosen
C = coeff_tt;
...
save("./data/double_rosen_full_rank.mat");